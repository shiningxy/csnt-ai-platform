...
export function AlgorithmCard({ algorithm, className }: AlgorithmCardProps) {
  ...
  return (
    <Card 
      className={cn(
        "group relative overflow-hidden border-border/50 bg-gradient-card transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1",
        className
      )}
    ...
    >
      ...
      <CardFooter className="pt-0">
        <div className={cn(
          "flex w-full space-x-2 transition-all duration-300",
      ...
      <div className={cn(
        "absolute inset-0 bg-gradient-to-r from-primary/5 via-transparent to-transparent transition-opacity duration-300",
        isHovered ? "opacity-100" : "opacity-0"
      )} />
    </Card>
  );
